...
The businesses don’t need to know how auditing works — they just “accept” the visitor.
...
| **ConcreteElement** | Implements `accept()` to call the visitor’s method. |
...
public:
    void visit(ConcreteElementA* element) override {
        cout << "ConcreteVisitor1: Visiting ElementA → ";
        element->operationA();
    }
    void visit(ConcreteElementB* element) override {
        cout << "ConcreteVisitor1: Visiting ElementB → ";
        element->operationB();
    }
};
...
ConcreteVisitor1: Visiting ElementA → ConcreteElementA operation executed.
ConcreteVisitor1: Visiting ElementB → ConcreteElementB operation executed.
...
- [GeeksforGeeks – Visitor Design Pattern in C++](https://www.geeksforgeeks.org/system-design/visitor-design-pattern/)
