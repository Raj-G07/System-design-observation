...
!!! note ""
    ...
    > ✅ **Use Case:** When you want to treat a group of objects (like folders or UI elements) the same way as individual ones.
...
Thus, both **File** and **Folder** behave uniformly — this is exactly what the Composite Pattern provides.
...
- Makes the system extensible — easy to add new types of components
...
???+ link 
     ...
     - [GeeksforGeeks – Composite Design Pattern](https://www.geeksforgeeks.org/java/composite-design-pattern-in-java/)
