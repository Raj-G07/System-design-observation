# 🚫 Problems Without Design Principles & ✅ SOLID Principles

## 💥 What Happens Without Design Principles
...
✅ Each class should handle one specific job.  
❌ Don’t mix responsibilities like database operations and UI logic in the same class.
...
✅ If a program expects a parent class, any subclass should work without issues.
