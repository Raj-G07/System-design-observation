...
## 💡 Real-World Analogy
Think of **biological cloning** — you can create identical copies of a living organism without recreating it from the very beginning.  
In software, the prototype is the original “template object,” and cloning it creates new objects with the same state.
...
- **Improves performance** — cloning is faster than reinitializing complex objects.
- **Avoids subclass explosion** — new configurations don’t require subclass creation.
...
- [GeeksforGeeks – Prototype Design Pattern in C++](https://www.geeksforgeeks.org/system-design/prototype-design-pattern/)
