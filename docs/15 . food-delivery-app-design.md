...
public:
    ...
    void prepareOrder() {
        cout << "\n👨‍🍳 " << name << " is preparing your food...\n";
        this_thread::sleep_for(chrono::seconds(2));
        cout << "✅ Food prepared successfully!\n";
    }
};
...
public:
    ...
    void deliverOrder(Order& order) {
        cout << "\n🚴 " << name << " picked up the order.\n";
        order.updateStatus(OrderStatus::OUT_FOR_DELIVERY);
        order.trackOrder();
        this_thread::sleep_for(chrono::seconds(2));
        order.updateStatus(OrderStatus::DELIVERED);
        cout << "✅ " << name << " delivered your order successfully!\n";
    }
};
...
public:
    ...
    void checkout(Restaurant& restaurant) {
        ...
        if (Payment::process(total)) {
            ...
            cout << "\n🧾 Order ID: " << order.getId() << " placed successfully!\n";
